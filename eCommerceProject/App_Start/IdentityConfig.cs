...
namespace eCommerceProject
{
    ...
    public class ApplicationUserManager : UserManager<MyUser, long>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<MyUser, MyRole, long, MyLogin, MyUserRole, MyClaim>(context.Get<ApplicationDbContext>())) { PasswordHasher = new MyPasswordHasher() };
    ...
    public class ApplicationRoleManager : RoleManager<MyRole, long>
    {
        public ApplicationRoleManager(IRoleStore<MyRole, long> store) : base(store) { }

        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options,
            IOwinContext context)
        {
            return new ApplicationRoleManager(new RoleStore<MyRole,long, MyUserRole>(context.Get<ApplicationDbContext>()));
        }
    }
